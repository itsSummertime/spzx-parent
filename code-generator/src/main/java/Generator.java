        ...
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/db_spzx",
                ...
                .globalConfig(builder -> {
                    builder.author("atguigu") // 设置作者
                            ...
                            .outputDir("D:\\javacode\\spzx-parent\\spzx-service\\service-order\\src\\main\\java") // 指定输出目录，一般指定到java目录
                ...
                .packageConfig(builder -> {
                    builder.parent("com.atguigu.spzx.product") // 设置父包名
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml,
                                        "D:\\javacode\\spzx-parentt\\spzx-service\\service-order\\src\\main\\resources\\mapper\\user")); // 设置mapperXml生成路径
                })
                //策略配置(StrategyConfig)
